...
The root export provides `glue`, `glueRuns`, and TypeScript types. Use `@typehug/core/html` for `glueHtml`. The HTML parser is kept outside the plain-text import graph, but remains an installed dependency of the shared core.
